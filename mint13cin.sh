...
sudo sed -i.bak 's/packages.linuxmint.com/mirror.nus.edu.sg\/LinuxMint/' /etc/apt/sources.list
...
sudo apt-get -y install build-essential libreadline6-dev curl git-core zlib1g-dev libssl-dev libyaml-dev libsqlite3-dev sqlite3 libxml2-dev libxslt1-dev autoconf libncurses5-dev automake libtool bison subversion ttf-inconsolata gitk
...
sudo apt-get -y install libgnome2-dev libgnomeui-dev libgtk2.0-dev libatk1.0-dev libbonoboui2-dev libcairo2-dev libxpm-dev libxt-dev mercurial
